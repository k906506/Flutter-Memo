                  ...
                  child: Column(
                    children: <Widget>[
                      TextFormField(
                        ...
                        onSaved: (value) {
                          _addMemo = Memo(_addMemo.id, value.toString(),
                              _addMemo.content, _addMemo.uploadDate);
                        },
                        validator: (value) {
                      ...
                      Container(
                        ...
                        child: Container(
                          ...
                          child: TextFormField(
                            ...
                            onSaved: (value) {
                              _addMemo = Memo(_addMemo.id, _addMemo.title,
                                  value.toString(), _addMemo.uploadDate);
                            },
                            validator: (value) {
                              if (value.toString().isEmpty) {
                                return "내용은 필수사항입니다.";
